...
public class InclusionController {
    ...
    public static InclusionController getInstance() {
        if (ourInstance.needToConfigure())
            ourInstance.configure();
        return ourInstance;
    }
    ...
    private long findMaxConfigModificationTime() throws IOException{
        ...
        // don't check more often than  MODIFICATION_TIME_VERIFICATION_FREQUENCE
        if (lastModificationTimeVerification+MODIFICATION_TIME_VERIFICATION_FREQUENCE>System.currentTimeMillis())
            return configurationFilesMaxModificationTime;
        ...
        while (resources.hasMoreElements()) {
            ...
            try {
                ...
                if (file.exists() && res<file.lastModified())
                    res = file.lastModified();
            } catch (URISyntaxException e) {
                // resource is not a file -> do nothing
    ...
    public void printImports(PageContext pageContext, Writer out, String groupNames, boolean exploded) throws IOException {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (g == null)
                throw new RuntimeException("Group '" + groupName + "' not found in " + CONFIGURATION_FILE_NAME);
                ...
                DefaultHandler saxHandler = new DefaultHandler() {
                    ...
                    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
                        if ("group".equals(qName)) {
                            ...
                            group.setMinimize(!"false".equals(minimizeJs));  // default: true
                            group.setMinimizeCss("true".equals(minimizeCss)); // default false
                    ...
                    public void endElement(String uri, String localName, String qName) throws SAXException {
                        if ("group".equals(qName))
                            ...
                            if (subGroup == null)
                                throw new RuntimeException("Error parsing " + url.toString() + " <group-ref>" + name + "</group-ref> unknown");
