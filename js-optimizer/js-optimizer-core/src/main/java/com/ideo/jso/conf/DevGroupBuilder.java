...
/**
 * Default development group builder
 * Each group's files last modification's time is scanned every time a build is required.
 * Cooldown of 30 seconds. 
 * 
 * @author Julien Maupoux
 *
 */
public class DevGroupBuilder extends AbstractGroupBuilder {
