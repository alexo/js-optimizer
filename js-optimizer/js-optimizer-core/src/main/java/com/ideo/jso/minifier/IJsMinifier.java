...
/**
 * This interface represents the contract for a JavaScript minifier
 * Implements this method to write your own minifier, then bind it in the configuration file.
 * 
