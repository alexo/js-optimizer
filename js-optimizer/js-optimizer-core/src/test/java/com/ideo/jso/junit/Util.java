...
public class Util {
	...
	static public long getFileTimeStamp(String fileClassPath, String mockWebUrl) throws Exception {
	...
	static public long getJSFilesTimestamp(Group group)throws Exception {
	...
	static public long getCSSFilesTimestamp(Group group)throws Exception {
